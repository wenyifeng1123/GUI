...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.matplotlibwidget_static_2.setGeometry(QtCore.QRect(230, 30, 821, 691))
        ...
        self.horizontalSlider.setGeometry(QtCore.QRect(20, 660, 531, 22))
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.lcdNumber = QtWidgets.QLCDNumber(self.matplotlibwidget_static_2)
        self.lcdNumber.setGeometry(QtCore.QRect(580, 660, 71, 23))
